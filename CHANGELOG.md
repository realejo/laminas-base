...
## [4.1.0] - 2021-12-08
### Fixed
- False values on boolean casting in ArrayObject

## [4.0.1] - 2021-06-30
### Changed
- Changed the casting for MapperAbstract::fetchAll()
- Changed the casting for ArrayObject::mappedKeys

## [4.0.0] - 2021-06-30
### Changed
- Everything is using type cast

## [3.0.3] - 2020-12-16
### Changed
- BackupService now has `--set-gtid-purged=OFF` in the dump command

## [3.0.2] - 2020-10-28
### Changed 
- Removed dependency from `laminas/laminas-dependency-plugin`
